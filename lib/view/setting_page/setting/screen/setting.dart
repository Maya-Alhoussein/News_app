          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Padding(
                  padding: EdgeInsets.only(right: SizeConfig.widthPercentage(2.0)),
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildSection(
                    ...
                    textColor: themeController.isDarkMode.value ? Colors.white : Colors.white,
                    titleTextColor: themeController.isDarkMode.value ? Colors.white : Colors.grey,
                    descriptionTextColor: themeController.isDarkMode.value ? Colors.white : Colors.black,
                  ),
                  ...
                  _buildSection(
                    ...
                    description: 'اختر الوضع الملائم لتشغيل الفيديوهات تلقائيا',
                    options: [
                  ...
                  _buildSection(
                    ...
                    selectedIndex: RxInt(themeController.isDarkMode.value ? 0 : 1), // تحديث القيمة بشكل صحيح
                    onChanged: (int index) {
                      if (index == 0) {
                        // الوضع النهاري
                        ...
                        var brightness = SchedulerBinding.instance.window.platformBrightness; // استخدام SchedulerBinding
                      ...
                      themeController.toggleTheme(); // تحديث الثيم بعد اختيار الإعداد
                    },
