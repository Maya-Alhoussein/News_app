...
import 'package:neww_app/service/link.dart';
import 'package:neww_app/service/my_sevice.dart'; // إضافة استيراد MyService
  ...
  Future<void> logout() async {
    try {
      ...
      if (token == null) {
        ...
        Get.snackbar("خطأ", "لم يتم العثور على التوكن. يرجى تسجيل الدخول مجددًا.",
