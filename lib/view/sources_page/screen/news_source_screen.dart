...
class NewsSourceScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      ...
      final textColor = themeController.isDarkMode.value ? Colors.white : Mycolor.black;
      final buttonColor = themeController.isDarkMode.value ? Mycolor.black : Mycolor.white;
      final appBarColor = themeController.isDarkMode.value ? Mycolor.darkThem : Mycolor.white;
      final buttonTextColor = themeController.isDarkMode.value ? Mycolor.white : Colors.black;
        ...
        child: Scaffold(
            ...
            title: Padding(
              ...
              child: Text(
                ...
                style: FontStyles.notificationsTitle.copyWith(
                  fontSize: SizeConfig.widthPercentage(5), // Responsive font size
          ...
          body: Padding(
            padding: EdgeInsets.symmetric(
              horizontal: SizeConfig.widthPercentage(5), // Responsive horizontal padding
              vertical: SizeConfig.heightPercentage(3), // Responsive vertical padding
            ),
            child: Column(
              children: [
                ...
                Expanded(
                  child: Obx(() {
                    ...
                    return GridView.builder(
                      padding: EdgeInsets.all(SizeConfig.widthPercentage(2)), // Responsive padding
                      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                        crossAxisCount: 3,
                        mainAxisSpacing: SizeConfig.heightPercentage(3), // Responsive spacing
                        crossAxisSpacing: SizeConfig.widthPercentage(3), // Responsive spacing
                              ...
                              child: Stack(
                                ...
                                children: [
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(
                                          SizeConfig.widthPercentage(2)), // Responsive radius
                                  ...
                                  SizedBox(
                                    ...
                                    child: CircleAvatar(
                                      radius: SizeConfig.widthPercentage(8), // Responsive radius
                            ...
                            ElevatedButton(
                              ...
                              style: ElevatedButton.styleFrom(
                                backgroundColor: source.isFollowing
                                    ? Mycolor.gray1
                                    : buttonColor,
                                foregroundColor: textColor, // استخدام اللون بناءً على الثيم
                                minimumSize: Size(
                                  SizeConfig.widthPercentage(25), // Responsive width
                                  SizeConfig.heightPercentage(5), // Responsive height
                                ),
                                shape: RoundedRectangleBorder(
                                  borderRadius: BorderRadius.circular(
                                      SizeConfig.widthPercentage(2)), // Responsive radius
                                  side: BorderSide(color: textColor), // استخدام اللون بناءً على الثيم
                                ),
                              ),
                              child: Text(
                ...
                Padding(
                  padding: EdgeInsets.only(bottom: SizeConfig.heightPercentage(3)),
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: themeController.isDarkMode.value ? Colors.white : Colors.black, // خلفية الزر
                      shape: RoundedRectangleBorder(
                    ...
                    child: Text(
                      "التالي",
                      style: GoogleFonts.cairo(
                        color: themeController.isDarkMode.value ? Colors.black : Colors.white, // لون النص
                        fontSize: SizeConfig.widthPercentage(4),
                      ),
                    ),
                  ),
