  ...
  Widget build(BuildContext context) {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Future.delayed(const Duration(seconds: 3), () {
        Get.offAndToNamed("/log_in_screen"); // الانتقال إلى شاشة تسجيل الدخول باستخدام GetX
      });
    });
    ...
    return Scaffold(
      ...
      body: Center(
        child: Stack(
          ...
          children: [
            Positioned(
              top: SizeConfig.heightPercentage(33), // موقع الصورة الأولى كنسبة مئوية من ارتفاع الشاشة
            ...
            Positioned(
              top: SizeConfig.heightPercentage(49), // موقع الصورة الثانية كنسبة مئوية من ارتفاع الشاشة
            ...
            Positioned(
              top: SizeConfig.heightPercentage(62), // موقع النص كنسبة مئوية من ارتفاع الشاشة
              child: Text(
                ...
                style: GoogleFonts.cairo(
                  textStyle: FontStyles.subtitle.copyWith(
                    ...
                    fontSize: SizeConfig.widthPercentage(4.5), // تحديد حجم الخط بناءً على عرض الشاشة
                  ),
                ),
              ),
            ),
