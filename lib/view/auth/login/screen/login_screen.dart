    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            SizedBox(height: SizeConfig.heightPercentage(11)), // 10% من ارتفاع الشاشة
            Center(
              child: Image.asset(
            ...
            SizedBox(height: SizeConfig.heightPercentage(3)), // 3% من ارتفاع الشاشة
            // حقول الإدخال
            EmailInputField(
            ...
            SizedBox(height: SizeConfig.heightPercentage(4)), // 5% من ارتفاع الشاشة
            EmailInputField(
              hintText: 'كلمة السر',
            ...
            ElevatedButton(
              onPressed: () async {
                // التحقق من المدخلات قبل استدعاء دالة تسجيل الدخول
