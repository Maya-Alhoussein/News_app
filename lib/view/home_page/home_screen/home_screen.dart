  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        toolbarHeight: 100,
        title: Padding(
          padding: EdgeInsets.only(top: SizeConfig.heightPercentage(3)), // استخدام SizeConfig هنا
          child: Align(
          ...
          child: Row(
            ...
            children: [
              IconButton(
                ...
                icon: Image.asset(
                  AppImage.menu,
                  width: SizeConfig.widthPercentage(5), // استخدام SizeConfig هنا
          ...
          return SingleChildScrollView(
            child: Padding(
              padding: EdgeInsets.symmetric(
                  horizontal: SizeConfig.widthPercentage(1)), // استخدام SizeConfig هنا
              child: Column(
                children: [
                  CustomSearchBar(
                    ...
                    children: [
                      TextButton(
                        ...
                        child: Text(
                          'مشاهدة الكل',
                          style: themeController.isDarkMode.value
                              ? FontStyles.newsCategorytext.copyWith(color: Colors.white) // اللون الأبيض في الوضع الداكن
                      ...
                      TextButton(
                        ...
                        child: Text(
                          'اخر الأخبار',
                          style: themeController.isDarkMode.value
                              ? FontStyles.latestnewsText.copyWith(color: Colors.white) // اللون الأبيض في الوضع الداكن
                  ...
                  SizedBox(
                    height: SizeConfig.heightPercentage(2), // استخدام SizeConfig هنا
                  ),
                  Obx(() {
        ...
        return TextButton(
          ...
          child: Text(
            ...
            style: themeController.isDarkMode.value
              ...
              color: isSelected ? Colors.white : Colors.white, // أسود دائمًا في الوضع الداكن
              fontWeight: isSelected ? FontWeight.bold : FontWeight.normal,
            )
                : FontStyles.newsCategorytext.copyWith(
              color: isSelected ? Colors.black : Colors.black, // أبيض دائمًا في الوضع الفاتح
              fontWeight: isSelected ? FontWeight.bold : FontWeight.normal,
            ),
          ),
        );
