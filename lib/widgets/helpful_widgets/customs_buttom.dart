...
import '../general/bottom_back.dart';
    ...
    return Obx(() {
      ...
      return Padding(
        padding: EdgeInsets.symmetric(
          vertical: SizeConfig.heightPercentage(1), // المسافة الرأسية نسبة للارتفاع
        ),
            ...
            children: [
              ...
              Padding(
                padding: EdgeInsets.only(
                  left: SizeConfig.widthPercentage(2.5), // مسافة ديناميكية بناءً على عرض الشاشة
                ),
              ...
              Expanded(
                child: Row(
                  ...
                  children: [
                    ...
                    SizedBox(
                      width: SizeConfig.widthPercentage(3), // المسافة بين النص والأيقونة
                    ),
                    // الأيقونة
                    Image.asset(
                      iconPath,
                      width: SizeConfig.widthPercentage(5), // حجم الأيقونة نسبي للعرض
                      height: SizeConfig.heightPercentage(5), // حجم الأيقونة نسبي للارتفاع
